...
pipeline_input_params: dict = {
    {
        example_component_1.component_name: {
            "x": {"type": int, "dsec": "Input number param 1", "value": 0, "arg_name": "a"},
            "y": {"type": int, "desc": "Input number param 2", "value": 0, "arg_name": "b"},
        },
        example_component_2.component_name: {
            "operation_type": {"type": str, "desc": "Select operation", "value": None},
        },
    }
}
